...
>
> The **real** Privacy Policy is deliberately deferred until v1 is
> feature-complete, so that it accurately describes the final data flows
> (this is a tracked, intentional decision — see `PRE_LAUNCH_CHECKLIST.md`,
> "Legal"). It is **not** an oversight.
